...
function showScreen(str) {
  ...
  $('.mini-screen').val(str)
  $('.mini-screen').scrollLeft(screen.length * 10)
}
...
// 绑定事件---------
$('.button-num').click(btnNumber);
$('.button-operator').click(btnOperator);
$('.notice').click(alertClear);
$('#button-left').click(buttonLeft);
$('#button-right').click(buttonRight);
$('#button-sum').click(buttonSum);
$('#button-back').click(buttonBack);
$('#button-ce').click(buttonCE);
